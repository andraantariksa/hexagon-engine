...
namespace Hx { namespace Math {
	...
	HX_STDMATH_MAKE_TEMPLATE_FUNCTION1(Log, std::log)
	HX_STDMATH_MAKE_TEMPLATE_FUNCTION1(Log10, std::log10)
	...
	HX_STDMATH_MAKE_FLOAT_FUNCTION1(Log, logf)
	HX_STDMATH_MAKE_FLOAT_FUNCTION1(Log10, log10f)
